...
var openBlocMigrationGuide = {
  ...
  callback: () => {
    env.openExternal(import_coc3.Uri.parse("https://bloclibrary.dev/#/migration"));
  }
};
var openEquatableMigrationGuide = {
  name: "Open Migration Guide",
  callback: () => {
    env.openExternal(import_coc3.Uri.parse("https://github.com/felangel/equatable/blob/master/doc/migration_guides/migration-0.6.0.md"));
  }
};
var deps = [
