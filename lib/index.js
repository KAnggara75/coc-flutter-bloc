...
function promptForBlocName() {
  return import_coc9.workspace.callAsync("input", ["Bloc name (example: conter): "]);
}
async function promptForTargetDirectory() {
  return import_coc9.workspace.callAsync("input", [
...
function promptForCubitName() {
  return import_coc10.workspace.callAsync("input", ["Cubit name (example: conter): "]);
}
async function promptForTargetDirectory2() {
  return import_coc10.workspace.callAsync("input", [
